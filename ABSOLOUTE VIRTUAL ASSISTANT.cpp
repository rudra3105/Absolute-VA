...
int main()
{
    ...
    cout<<"\t\t\t< I'M BEN >"<<endl;
    cout<<"\t\t\t< MY NAME IS ABSOLUTE VIRTUAL ASSISTANT BEN >"<<endl;
        ...
        if(strcmp(password, "rudra")==0){
            ...
            do{
                ...
                if(strcmp(ch, "Hi") == 0 || strcmp(ch, "Hey") == 0 || strcmp(ch, "Hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by Rudra Bhatt !!!"<<endl;
                    string phrase = "I am a virtual assistant created by Rudra Bhatt";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    cout<<"I'm good, tell me how can I help you.."<<endl;
                    string phrase = "I'm good, tell me how can I help you";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
